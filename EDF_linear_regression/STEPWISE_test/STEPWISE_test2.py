...
lm_forward_BIC_result = factory.buildForward(i_min, log(45))

## Backward
lm_backward_AIC_result = factory.buildBackward(i_min, 2)
lm_backward_BIC_result = factory.buildBackward(i_min, log(45))

## Both
lm_both_AIC_result = factory.buildBoth(i_min, i_0, 2)
lm_both_BIC_result = factory.buildBoth(i_min, i_0, log(45))
